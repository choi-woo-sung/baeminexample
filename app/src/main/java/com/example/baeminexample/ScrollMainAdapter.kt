 ...
 * Description:
 */
class ScrollMainAdapter(private var image: ArrayList<Int>) : RecyclerView.Adapter<ScrollMainAdapter.ViewHolder>() {


    class ViewHolder(private val binding: ItemScrollCenterBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemScrollCenterBinding.inflate(LayoutInflater.from(viewGroup.context), viewGroup, false)
