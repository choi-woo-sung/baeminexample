 ...
 * Description:
 */
class item_header(val image: Int ) : BindableItem<ItemScrollHeaderBinding>() {


    override fun bind(itemScrollBulmiBinding: ItemScrollHeaderBinding, position: Int) {
    ...
    override fun getLayout(): Int {
        return (R.layout.item_scroll_header)
    }

    override fun initializeViewBinding(p0: View): ItemScrollHeaderBinding {

        return ItemScrollHeaderBinding.bind(p0)
    }
}