 ...
 * Description:
 */
class item_bulmi(val image: Int ) : BindableItem<ItemScrollBulmiBinding>() {


    override fun bind(itemScrollBulmiBinding: ItemScrollBulmiBinding, position: Int) {
    ...
    override fun getLayout(): Int {
        return (R.layout.item_scroll_bulmi)
    }

    override fun initializeViewBinding(p0: View): ItemScrollBulmiBinding {

        return ItemScrollBulmiBinding.bind(p0)
    }
}